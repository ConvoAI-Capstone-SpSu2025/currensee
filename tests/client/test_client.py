...
from currensee.client import AgentClient, AgentClientError
from currensee.schema import AgentInfo, ChatHistory, ChatMessage, ServiceMetadata
...
def test_info(agent_client):
    ...
    test_info = ServiceMetadata(
        ...
        default_model=GoogleModelName.GEMINI_15_FLASH,
        models=[GoogleModelName.GEMINI_15_FLASH],
    )
