...
from currensee.agents.agents import Agent
from currensee.schema import ChatHistory, ChatMessage, ServiceMetadata
...
def test_info(test_client, mock_settings) -> None:
    ...
    mock_settings.DEFAULT_MODEL = GoogleModelName.GEMINI_15_FLASH
    mock_settings.AVAILABLE_MODELS = {GoogleModelName.GEMINI_15_FLASH, GoogleModelName.GEMINI_20_FLASH}
    ...
    assert output.default_model == GoogleModelName.GEMINI_15_FLASH
    assert output.models == [GoogleModelName.GEMINI_15_FLASH, GoogleModelName.GEMINI_20_FLASH]