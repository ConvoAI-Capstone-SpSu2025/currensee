...
class UserInput(BaseModel):
    ...
    message: str = Field(
        ...
        examples=["Do I have any upcoming meetings with John Smith?"],
    )
    model: SerializeAsAny[AllModelEnum] | None = Field(
        title="Model",
        description="LLM Model to use for the agent.",
        default=GoogleModelName.GEMINI_15_FLASH,
        examples=[GoogleModelName.GEMINI_15_FLASH, GoogleModelName.GEMINI_20_FLASH],
    )
