...
def generate_report(result: Dict) -> str:
    ...
    client_industry_summary = result.get('client_industry_summary', str)
    macro_news_summary = result.get('macro_news_summary', [])
    macro_financial_snapshot = result.get('macro_financial_snapshot', [])
    financial_news_summary = result.get("financial_news_summary", "")
    client_company = result.get('client_company', 'Client')
    ...
    <tbody>
    """
    for row in macro_financial_snapshot:
    ...
    html_macro_news_sources = format_sources_to_html(macro_news_summary, 'Macro News')
